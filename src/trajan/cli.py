...
def parse_args():
    ...
    pair_distribution.add_argument("-tp", "--total-partial", nargs = "+", default = [], help = "Calculate the total correlation function as well as partial pairwise contributions based on the atom type mappings or custom neutron scattering lengths.\n This flag should be followd by a space separated list of atomic names or scattering lengths for each type in ascending order.")
